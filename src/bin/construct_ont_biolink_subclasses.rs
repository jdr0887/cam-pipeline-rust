...
#[structopt(name = "construct_ont_biolink_subclasses", about = "construct ontology biolink subclasses")]
struct Options {
...
fn main() -> Result<(), Box<dyn error::Error>> {
    ...
    let output_path: path::PathBuf = work_dir.clone().join("ont-biolink-subclasses.nt");
